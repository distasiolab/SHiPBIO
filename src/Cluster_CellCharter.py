...
cc.gr.aggregate_neighbors(samples_all, n_layers=3, use_rep='X_magic', out_key='X_cellcharter', sample_key='batch')
...
if SAVEDATA:
    # Save
    filename_out = os.path.join(FILEPATHBASE, 'calc', 'samples_all_integrated_imputed_cellcharter_clustered.h5ad')
...
if SAVEFIGS:
    n_clusters = len(samples_all.obs['spatial_cluster'].cat.categories)
    filename_out = os.path.join(IMGDIR, 'AllSamples_GIMVI_CellCharter_' + str(n_clusters) + '_Clusters_typelabels.png')
    fig.savefig(filename_out, dpi=300)
    print('Saved: ' + filename_out)
    filename_out = os.path.join(IMGDIR, 'AllSamples_GIMVI_CellCharter_' + str(n_clusters) + '_Clusters_typelabels.svg')
    fig.savefig(filename_out, dpi=300)
    print('Saved: ' + filename_out)
# --------------------------------------------------
